package com.example.fullscreen.Step11;
...
import com.example.fullscreen.Step11.adapter.ExampleAdapter;
...
public class Step11Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countriesList = (ListView) findViewById(R.id.step11ListView);
        // создаем адаптер
